...
//    private String randString = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";//随机产生数字与字母组合的字符串
     ...
     * 生成随机图片
     */
    public static String getRandcode(BufferedImage image) {
     ...
     * 图片写出到客户端
     */
    public static void writeImage(BufferedImage image, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (outputStream != null) {
                try {
                    ...
                    logger.error("数据流关闭异常：{}", e1.getMessage());
                }
            }
        }
    }
